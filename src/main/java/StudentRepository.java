...
//class which will be connected to database DB(connection, statement, prepared statement)
public class StudentRepository {
   ...
   private  void getConnection()  {
      try {
         this.con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/jdbc_db", "dev_user", "12345");
   ...
   //step 5: method to create prepared statement
   ...
   public void createTable(){
      ...
      try {
         ...
         //id is SERIAL, it means, id is generated by SQL
   ...
   //step 10 - method to persist data into database
      ...
      //step -12 : method to brıng all students from database
      public void findAll() {
      getConnection();
      ...
      public Student findStudentById(int id) {
         ...
         try {
            ...
            //if resultSet has some values (there is student information) then we need map result set to student
            while(resultSet.next()) {
               student = new Student();
